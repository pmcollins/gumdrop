...
import gumdrop.json.print.ArrayPrinter;
import gumdrop.json.print.IntPrinter;
import gumdrop.json.print.MapPrinter;
...
public class JsonPrinterTest extends Test {

  public static void main(String[] args) throws Exception {
    new JsonPrinterTest().run();
  }
